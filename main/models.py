...
class TarifCodes(models.Model):
    ...
    views_2 = models.CharField('Просмотров 2', max_length=20, blank=True, null=True)
...
class Tarif(models.Model):
    ...
    views_2 = models.IntegerField("Просмотров 2", default=0)
    views_2_speed = models.IntegerField("Скорость. Просмотров 2", default=0)
